...
const displayCountry = (arr) => {
  ...
  card = `<div class="flag ratio ratio-4x3">
                <img src="${arr[0].flag}" alt="Flag of ${
    arr[0].commonName
  }" class="img-fluid">
            </div>
            <div class="details h-100 d-flex align-items-center">
                <div class="details-wrap w-100">
                    <h2 class="country-name h3 fw-800 mb-4">${
                      arr[0].commonName
                    }</h2>
                    <div class="detail-columns my-3">
                        <div class="column1">
                            <p class="fw-600 fs-small mb-2">Native Name: <span class="native_name fw-300 opacity-9">${
                              arr[0].nativeName
                            }</span></p>
                            <p class="fw-600 fs-small mb-2">Population: <span class="population fw-300 opacity-9">${
                              arr[0].population
                            }</span></p>
                            <p class="fw-600 fs-small mb-2">Region: <span class="region fw-300 opacity-9">${
                              arr[0].region
                            }</span></p>
                            <p class="fw-600 fs-small mb-2">Sub-Region: <span class="sub-region fw-300 opacity-9">${
                              arr[0].subRegion
                            }</span></p>
                            <p class="fw-600 fs-small mb-3">Capital: <span class="capital fw-300 opacity-9">${
                              arr[0].capital
                            }</span></p>
                        </div>
                        <div class="column2">
                            <p class="fw-600 fs-small mb-2">Top Level Domain: <span class="tld fw-300 opacity-9">${
                              arr[0].tld
                            }</span></p>
                            <p class="fw-600 fs-small mb-2">Currencies: <span class="currencies fw-300 opacity-9">${
                              arr[0].currencies
                            }</span></p>
                            <p class="fw-600 fs-small mb-2">Languages: <span class="languages fw-300 opacity-9">${
                              arr[0].languages
                            }</span></p>
                        </div>
                    </div>
